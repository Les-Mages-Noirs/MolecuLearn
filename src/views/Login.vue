            ...
            <div class="w-2/3 h-100">
                ...
                <form class="mt-6" action="#" method="POST" @submit="onSubmit">
                    ...
                    <div class="text-right mt-2">
                        <a href="#" class="text-sm font-semibold text-gray-700 hover:text-primary focus:text-primary">Mot de
                            passe
                            oublié ?</a>
                    </div>
                ...
                <p class="mt-8">
                    Besoin d'un compte?
                    <a class="text-primary hover:text-primary font-semibold  cursor-pointer"
                        @click="navigateToSignup">S'inscrire</a>
                </p>
            </div>
